...
class AddInterPersonalQuestions extends StatefulWidget {
  const AddInterPersonalQuestions({Key? key}) : super(key: key);

  @override
  State<AddInterPersonalQuestions> createState() =>
      _AddInterPersonalQuestionsState();
}

class _AddInterPersonalQuestionsState extends State<AddInterPersonalQuestions> {
  ...
  Future<void> addInterPersonalQuestions() {
    return questions
        .add({
